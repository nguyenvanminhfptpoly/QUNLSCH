...
public class Suckhoe_sach {
    private int id;
    private String mTieude,mGioithieu;
    private double gia;

    public Suckhoe_sach(int id, String mTieude, String mGioithieu, double gia) {
        this.id = id;
    ...
    public Suckhoe_sach(String mTieude, String mGioithieu, double gia) {
