...
public class Ngoaingu_sach {
    private int id;
    private String mTieude,mGioithieu;
    private double gia;

    public Ngoaingu_sach(int id, String mTieude, String mGioithieu, double gia) {
        this.id = id;
    ...
    public Ngoaingu_sach(String mTieude, String mGioithieu, double gia) {
