...
public class KinhTe_sach {
    private int id;
    private String mTieude,mGioithieu;
    private double gia;

    public KinhTe_sach(int id, String mTieude, String mGioithieu, double gia) {
        this.id = id;
    ...
    public KinhTe_sach( String mTieude, String mGioithieu, double gia) {
